...
// display the cards of player 1  - took here - check this - turn ON
// let deal = document.getElementById('deal');
// deal.addEventListener('click', dealCards);
dealCards();
// setTimeout(dealCards, 100);

console.log('p1 hand',players.p1.hand);
console.log('p2 hand',players.p2.hand);
console.log('p3 hand',players.p3.hand);
console.log('p4 hand',players.p4.hand);

// debugger;
table.push(players.p1.hand.pop());
