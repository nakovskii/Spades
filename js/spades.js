...
const translateCard = (disp1, disp2) => {
    pCard.style.transform = `translateXY(${disp1}px, ${disp2})`;
};
...
const displayPlayer1Cards = () => {
    ...
    for (let i=0; i< players.p2.hand.length; i++){
        ...
        pCard.addEventListener('click', (e) => {
            ...
            console.log(selectedCardindex);
            if (checkSuitPresence(players.p1.hand) && players.p1.hand[selectedCardindex].suit != trickSuit){
                    console.log(pCard);
...
const displayPlayer3Cards = () => {
    ...
    for (let i=0; i< players.p3.hand.length; i++){
        ...
        pCard.addEventListener('click', (e) => {
            ...
            console.log(selectedCardindex);
            // setInterval(translateCard, 250, x, 200);
            pCard.style.transform = 'translateX(200px)';
...
console.log("p0",players.p0.hand);
// debugger;
p0sortedHand = players.p0.hand.sort(compareSort);
console.log("po sorted:",p0sortedHand);
